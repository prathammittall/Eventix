                    ...
                    >
                        {clubs[currentSet] && clubs[currentSet].map((club, index) => (
                            <motion.div
                                ...
                                data-aos="zoom-in-up"
                                whileTap={{ y: -10 }}
                                className="relative w-72 h-[400px] bg-cover bg-center rounded-xl flex flex-col justify-between p-6 shadow-lg bg-gray-800 transition-shadow duration-500 hover:shadow-[0_0_20px_5px_rgba(168,85,247,0.5)]"
                            >
